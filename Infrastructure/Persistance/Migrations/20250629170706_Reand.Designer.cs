...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250629170706_Reand")]
    partial class Reand
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.Projects.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 6, 29, 21, 37, 6, 303, DateTimeKind.Local).AddTicks(5379),
                            ...
                            StartDate = new DateTime(2025, 6, 29, 21, 37, 6, 303, DateTimeKind.Local).AddTicks(5335),
                            Title = "Public Project",
                            UpdateDate = new DateTime(2025, 6, 29, 21, 37, 6, 303, DateTimeKind.Local).AddTicks(5381)
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    ...
                    b.ToTable("AspNetRoleClaims", "Calendar");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    ...
                    b.ToTable("AspNetUserClaims", "Calendar");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserLogin<string>", b =>
                {
                    ...
                    b.ToTable("AspNetUserLogins", "Calendar");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserToken<string>", b =>
                {
                    ...
                    b.ToTable("AspNetUserTokens", "Calendar");
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.Notifications.Notification", b =>
                {
                    b.HasOne("Core.Domain.Entities.Requests.Request", "Request")
                        .WithOne("Notification")
                        .HasForeignKey("Core.Domain.Entities.Notifications.Notification", "RequestId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Domain.Entities.Requests.Request", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.Users.User", "Receiver")
                        .WithMany("ReceiveRequests")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Core.Domain.Entities.Users.User", "Sender")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Core.Domain.Entities.Users.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
