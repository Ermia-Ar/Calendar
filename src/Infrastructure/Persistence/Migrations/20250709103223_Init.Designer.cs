            ...
            modelBuilder.Entity("Core.Domain.Entities.ActivityMembers.ActivityMember", b =>
                {
                    ...
                    b.ToTable("ActivityMembers", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.ActivityMembers.ActivityMember", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.Notifications.Notification", "Notification")
                        .WithOne("ActivityMember")
                        .HasForeignKey("Core.Domain.Entities.ActivityMembers.ActivityMember", "ActivityId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
