...
namespace Core.Application.Features.UserRequests.QueryHandler
{
    public class GetUnAnsweredRequestHandler : ResponseHandler
        , IRequestHandler<GetUnAnsweredRequestQuery, Response<List<RequestResponse>>>
    {
        ...
        public async Task<Response<List<RequestResponse>>> Handle(GetUnAnsweredRequestQuery request, CancellationToken cancellationToken)
        {
