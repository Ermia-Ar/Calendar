...
namespace Core.Application.Features.Projects.QueryHandlers
{
    public class GetUnAnsweredRequestHandler : ResponseHandler
        , IRequestHandler<GetUnAnsweredProjectRequestQuery, Response<List<ProjectRequestResponse>>>
    {
        ...
        public async Task<Response<List<ProjectRequestResponse>>> Handle(GetUnAnsweredProjectRequestQuery request, CancellationToken cancellationToken)
        {
            try
            {
