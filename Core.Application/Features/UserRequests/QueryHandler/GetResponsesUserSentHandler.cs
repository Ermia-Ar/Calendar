...
namespace Core.Application.Features.UserRequests.QueryHandler
{
    ...
    public sealed class GetResponsesUserSentHandler 
        : IRequestHandler<GetResponsesUserSentQuery, List<RequestResponse>>
    {
        ...
        public async Task<List<RequestResponse>> Handle(GetResponsesUserSentQuery request, CancellationToken cancellationToken)
        {
